...
adash: adash.go ui/dist $(if $(BUILD_TAGS_OPT),internal/dev_server/swagger-ui-dist,) $(shell git ls-files internal --cached --others --exclude-standard)
